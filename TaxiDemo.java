...
public class TaxiDemo
{
    ...
    private void pruebas() {
        ...
        Location destino = new Location(3,4);
        Location aux = new Location(0,0);
        
        System.out.println("Distancia: " +l1.distance(destino));
        aux = aux.nextLocation(destino);
        System.out.println("Next: " + aux);//1,1
        aux= aux.nextLocation(destino);
        System.out.println("Next: " + aux); //Deberia ser : 2,2
